...
import com.semantyca.djinn.dto.radiostation.BrandScriptEntryDTO;
import com.semantyca.djinn.dto.radiostation.OwnerDTO;
import com.semantyca.djinn.dto.radiostation.ProfileOverridingDTO;
...
public class BrandService extends AbstractService<Brand, BrandDTO> {
    ...
    @Inject
    public BrandService(UserService userService, BrandRepository repository, DjinnConfig djinnConfig) {
        super(userService);
